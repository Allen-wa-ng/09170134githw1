...
background = pygame.transform.scale(
    background, (500, 750))  # screen background
...
while Running:
    ...
    createText('TIME:'+getTimeformat(duration), 'arial.ttf',
               20, black, (315, 91))  # display clock
    # Text
    Text()
    # number set
    pygame.draw.rect(screen, col_list[int(
        getBaseLog(2, next_num))-1], (175, 81, 38, 38), 0)
    createText(str(next_num), 'arial.ttf', 20, black,
               (168+25-len(str(next_num))*5, 89))
    # block moving
